...
new_complete_file = open("data_wneg.txt", 'r', encoding='utf-8')
...
fold_size = int(len(doc_content) / 5)
for fold in range(1,6):
    ...
    for j in range((fold-1)*fold_size, (fold)*fold_size):
        ...
        fold_test.write("{} {} {} {}\n".format(j+1, content_list[0].split()[1], content_list[0].split()[2], content_list[0].split()[3]))
